...
OZLIB=$OZLIB:$OZSERVER_HOME/WEB-INF/lib/ozsfw90.jar
...
#        Library for XML
# -----------------------------------
OZLIB=$OZLIB:$OZSERVER_HOME/WEB-INF/lib/xalan-2.7.3.jar
OZLIB=$OZLIB:$OZSERVER_HOME/WEB-INF/lib/xercesImpl-2.12.2.jar
OZLIB=$OZLIB:$OZSERVER_HOME/WEB-INF/lib/xml-apis-1.4.01.jar
OZLIB=$OZLIB:$OZSERVER_HOME/WEB-INF/lib/parser.jar
OZLIB=$OZLIB:$OZSERVER_HOME/WEB-INF/lib/dom4j-2.1.4.jar
...
OZLIB=$OZLIB:$OZSERVER_HOME/WEB-INF/lib/soap3_0_0.jar
