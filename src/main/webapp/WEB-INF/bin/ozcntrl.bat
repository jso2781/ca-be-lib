...
rem        OZ Main Class
rem -----------------------------------
set OZLIB=%OZLIB%;%OZLIBALL%\ozsfw90.jar;%OZSERVER_HOME%\conf\
...
rem        Library for XML
rem -----------------------------------
set OZLIB=%OZLIB%;%OZLIBALL%\xalan-2.7.3.jar
set OZLIB=%OZLIB%;%OZLIBALL%\xercesImpl-2.12.2.jar
set OZLIB=%OZLIB%;%OZLIBALL%\xml-apis-1.4.01.jar
set OZLIB=%OZLIB%;%OZLIBALL%\parser.jar
set OZLIB=%OZLIB%;%OZLIBALL%\dom4j-2.1.4.jar
...
set OZLIB=%OZLIB%;%OZLIBALL%\soap3_0_0.jar
